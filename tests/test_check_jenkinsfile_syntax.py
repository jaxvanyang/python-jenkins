...
class JenkinsCheckJenkinsfileSyntax(JenkinsTestBase):
    ...
    def test_check_syntax_of_a_valid_file(self, session_send_mock):
        ...
        self.assertEqual(response, valid_response.get("data", {}).get("errors", []))
    ...
    def test_check_syntax_of_an_invalid_file(self, session_send_mock):
        ...
        invalid_response = {
         ...
         "data": {
          ...
          "errors": [
           {
            "error": [
             "Unknown stage section \"stexps\". Starting with version 0.5, steps in a stage must be in a \u2018steps\u2019 block. @ line 5, column 9.",
        ...
        self.assertEqual(response, invalid_response.get("data", {}).get("errors", []))
